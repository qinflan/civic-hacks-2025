...
export default function AboutUs() {
  ...
  const websiteDescription = `
    Our platform provides a comprehensive tool for analyzing biodiversity.
    Users can input data such as latitude or species IDs to retrieve detailed information on the biodiversity
    in that region and how its impact. We aim to raise awareness and support sustainable development
    ...
    <>
      <main className="p-6 max-w-3xl mx-auto text-center flex flex-col items-center bg-gradient-to-b from-green-100 to-white min-h-screen">
        ...
        <section className="text-2xl font-semibold leading-relaxed p-6 text-center">
          Our Project is to{" "}
          <span className="text-blue-500 font-bold">Record</span> the world’s{" "}
          <span className="text-red-500 font-bold">Biodiversity</span> and Make it{" "}
          <br />
          <span className="text-green-600 font-bold">Universally Accessible</span> and{" "}
          <span className="text-orange-500 font-bold">Comprehensive</span>.
        </section>
